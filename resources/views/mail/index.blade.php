              ...
              <tr>
                <td><table border="0" cellspacing="0" cellpadding="0" align="left" class="inner" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
                    <tr>
                      ...
                      <td height="75" class="inner" valign="middle"><a href="#"><img class="logo" src="{{ asset('assets/pages/img/mail/logo.png')}}" width="180" height="61" alt="Logo"></a></td>
                    </tr>
                  </table>
                ...
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                    <tr>
                      ...
                      <td><table width="76%" border="0" cellspacing="0" cellpadding="0" align="left" class="inner" id="banner" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
                        ...
                        <table width="22%" border="0" cellspacing="0" cellpadding="0" align="right" class="inner" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
                          <tr>
                            <td align="center"><a href="#" style="margin-top:5px; display:inline-block;"><img src="{{ asset('assets/pages/img/mail/facebook.png')}}" width="32" height="atuo" alt="Social Media" /></a></td>
                            <td align="center"><a href="#" style="margin-top:5px; display:inline-block;"><img src="{{ asset('assets/pages/img/mail/twitter.png')}}" width="32" height="atuo" alt="Social Media" /></a></td>
                            <td align="center"><a href="#" style="margin-top:5px; display:inline-block;"><img src="{{ asset('assets/pages/img/mail/google.png')}}" width="32" height="atuo" alt="Social Media" /></a></td>
                          </tr>
                          <tr>
                            <td height="20">&nbsp;</td>
                            <td height="20">&nbsp;</td>
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                    <tr>
                      ...
                      <td width="93.33%"><img class="imgresponsive" src="{{ asset('assets/pages/img/mail/banner.jpg')}}" width="554" height="atuo" alt="Banner" /></td>
                      <td width="3.33%" class="sidespace">&nbsp;</td>
                    </tr>
                    <tr>
                      <td height="20">&nbsp;</td>
