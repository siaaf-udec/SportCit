                ...
                <div class="page-quick-sidebar-chat-users" data-rail-color="#ddd"
                    ...
                    <ul class="media-list list-items">
                        <li class="media">
                            ...
                            <img class="media-object" src="{{ asset('assets/layouts/layout2/img/avatar3.jpg') }}"
                                 alt="Avatar">
                        ...
                        <li class="media">
                            <img class="media-object" src="{{ asset('assets/layouts/layout2/img/avatar1.jpg') }}"
                                 alt="Avatar">
                            <div class="media-body">
                        ...
                        <li class="media">
                            ...
                            <img class="media-object" src="{{ asset('assets/layouts/layout2/img/avatar4.jpg') }}"
                                 alt="Avatar">
                            <div class="media-body">
                        ...
                        <li class="media">
                            <img class="media-object" src="{{ asset('assets/layouts/layout2/img/avatar2.jpg') }}"
                                 alt="Avatar">
                            <div class="media-body">
                    ...
                    <ul class="media-list list-items">
                        <li class="media">
                            ...
                            <img class="media-object" src="{{ asset('assets/layouts/layout2/img/avatar6.jpg') }}"
                                 alt="Avatar">
                            <div class="media-body">
                        ...
                        <li class="media">
                            ...
                            <img class="media-object" src="{{ asset('assets/layouts/layout2/img/avatar7.jpg') }}"
                                 alt="Avatar">
                            <div class="media-body">
                        ...
                        <li class="media">
                            <img class="media-object" src="{{ asset('assets/layouts/layout2/img/avatar8.jpg') }}"
                                 alt="Avatar">
                            <div class="media-body">
                        ...
                        <li class="media">
                            ...
                            <img class="media-object" src="{{ asset('assets/layouts/layout2/img/avatar9.jpg') }}"
                                 alt="Avatar">
                            <div class="media-body">
                        ...
                        <li class="media">
                            <img class="media-object" src="{{ asset('assets/layouts/layout2/img/avatar10.jpg') }}"
                                 alt="Avatar">
                            <div class="media-body">
                        ...
                        <li class="media">
                            ...
                            <img class="media-object" src="{{ asset('assets/layouts/layout2/img/avatar11.jpg') }}"
                                 alt="Avatar">
                            <div class="media-body">
